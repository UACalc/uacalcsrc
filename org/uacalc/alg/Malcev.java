...
public class Malcev {
  ...
  /**
   * Find a near majority term for (the variety generated by) this 
   * algebra or <tt>null</tt> if there is none. 
   * A <i>near majority term</i> is one satifying
   ...
   * near-majority term. Questions (that Matt told me about):
   * <br>
   * 1. is there a finite algebra with Jonsson terms but no near 
   * majority term?
   * <br>
   * 2. is there a finite algebra with a near unamimity term but no 
   * near majority term?
   * <br>
   * The method looks in the subalgebra generated by (x,x,y,x),
   * (x,y,x,x), (y,x,x,x) for an element of the form (a,a,a,x).
   */
  public static Term nearMajorityTerm(SmallAlgebra alg) {
    return nearMajorityTerm(alg, false);
  }
   ...
   */
  public static Term nearMajorityTerm(SmallAlgebra alg, boolean isIdempotent) {

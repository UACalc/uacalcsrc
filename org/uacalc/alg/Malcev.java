...
public class Malcev {
  ...
  public static List<Term> sdmeetTerms(SmallAlgebra alg, ProgressReport report) {
    ...
    if (report != null) report.addStartLine("computing the subalgebra of F(2)^3 generated by (x,x,y) (x,y,x), (y,x,x).");
  ...
  public static Term findNUF(SmallAlgebra alg, int arity, ProgressReport report) {
    ...
    if (alg.isIdempotent()) {
      if (report != null) {
        ...
        report.addStartLine("Using Horitz's algorithm to if an NU exits");
      }
